...
class VGGBlock(torch.nn.Module):
    ...
    def __init__(self, in_channels: int, mid_channels: int, out_channels: int):
        ...
        self.seq = nn.Sequential('x, edge_index, edge_weight',
                                 [
...
class NestedUNet(torch.nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, init_filter: int = 32):
        ...
        nb_filter = [init_filter, init_filter*2, init_filter*4, init_filter*8, init_filter*16]
